# Generated by Django 2.1.7 on 2019-03-07 09:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Submitted', 'Submitted'), ('Being Reviewed', 'Being Reviewed'), ('Requested Interview', 'Requested Interview'), ('Interviewed', 'Interview'), ('Rejected', 'Rejected'), ('Accepted', 'Accepted')], default='Submitted', max_length=20)),
                ('feedback', models.CharField(default='No feedback available', max_length=50)),
            ],
        ),
        migrations.CreateModel(
